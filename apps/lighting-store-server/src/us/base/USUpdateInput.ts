...
class USUpdateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => OrderUpdateManyWithoutUsItemsInput,
  })
  @ValidateNested()
  @Type(() => OrderUpdateManyWithoutUsItemsInput)
  @IsOptional()
  @Field(() => OrderUpdateManyWithoutUsItemsInput, {
    nullable: true,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => ReviewUpdateManyWithoutUsItemsInput,
  })
  @ValidateNested()
  @Type(() => ReviewUpdateManyWithoutUsItemsInput)
  @IsOptional()
  @Field(() => ReviewUpdateManyWithoutUsItemsInput, {
    nullable: true,
  })
...
export { USUpdateInput as USUpdateInput };
